...
ControlClick, x296 y227, ahk_exe msedge.exe
loop {
 	PixelGetColor, avail, 706, 354, rgb
 	Sleep, 50
 } until avail = 0xDDDDDD
 sleep, 1000
ControlClick, x377 y275, Enter Support Order Int - SM - SO/WO Header Main
Send, 31800
sleep, 200
send, {TAB}
sleep, 200
send, 310%Jobonly%
sleep, 500
ControlClick, x489 y472, Enter Support Order Int - SM - SO/WO Header Main
...
if ErrorLevel
    ...
    mouseClick, Left,  % 244, Py
sleep, 300
	mouseclick, Left, % 244, Py+30
	sleep, 300
	MouseClick, Right, % 244, Py+30
	sleep, 500
...
#IfWinActive Epic Pipe Supports Data Entry
^LButton::
CoordMode, Mouse, Window
{
